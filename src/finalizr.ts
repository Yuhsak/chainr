...
export type Finalize<F extends Fn, R extends Fn> = {
  <H extends (...args: any[]) => MaybePromise<Parameters<R>[0]>>(handler: H): (...args: Parameters<H>) => (
    // SomePromise<[ReturnType<H>, ReturnType<R>]> extends Promise<any> ? PromiseOnce<ReturnType<F>> : ReturnType<F>
    ReturnType<H> extends Promise<any> ? PromiseOnce<ReturnType<F>> : ReturnType<R> extends Promise<any> ? PromiseOnce<ReturnType<F>> : ReturnType<F>
  )
  <T extends PromiseContent<ReturnType<F>>>(handler: () => MaybePromise<Parameters<R>[0]>): () => (
    // SomePromise<[ReturnType<typeof handler>, ReturnType<R>]> extends Promise<any> ? PromiseOnce<T> : T
    ReturnType<typeof handler> extends Promise<any> ? PromiseOnce<T> : ReturnType<R> extends Promise<any> ? PromiseOnce<T> : T
  )
  <A, T extends PromiseContent<ReturnType<F>>>(handler: (arg: A) => MaybePromise<Parameters<R>[0]>): (arg: A) => (
    // SomePromise<[ReturnType<typeof handler>, ReturnType<R>]> extends Promise<any> ? PromiseOnce<T> : T
    ReturnType<typeof handler> extends Promise<any> ? PromiseOnce<T> : ReturnType<R> extends Promise<any> ? PromiseOnce<T> : T
  )
}
